...
import com.dashidao.foundation.service.impl.UserServiceImpl;
...
public class ChatServer implements WebsoketListen, WebsocketInterceptor { 
	...
	public void getMessage(String message, Session session) {
		...
		if (jsonObject.get("init") != null && jsonObject.getString("init").equals("init")) {
			...
			if(WebsoketListen.SessionMap.get(WebsoketListen.SessionidMap.get(jsonObject.getString("toId")))!=null) {
