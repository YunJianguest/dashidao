...
import com.dashidao.foundation.domain.query.BargainGoodsQueryObject;
...
import com.dashidao.foundation.domain.query.GroupGoodsQueryObject;
...
public class IndexViewAction {
	...
	public ModelAndView footer(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("footer.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
		String dashidao_view_type = CommUtil.null2String(request.getSession().getAttribute("dashidao_view_type"));
	...
	@RequestMapping({ "/buyer/foot.htm" })
	public ModelAndView buyerfoot(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("/wap/buyer/foot.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
	...
	@RequestMapping({ "/yunke/foot.htm" })
	public ModelAndView yunkefoot(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("wap/yunke/foot.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// request, response);
		// 设置为PC访问
		// request.getSession().setAttribute("dashidao_view_type", "pc");
	...
	/*
	 * @RequestMapping({ "/404.htm" }) public ModelAndView
	 * error404(HttpServletRequest request, HttpServletResponse response){
	 * ModelAndView mv = new JModelAndView("404.html",
	 * this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1,
	 * request, response); String dashidao_view_type =
	 * CommUtil.null2String(request.getSession().getAttribute("dashidao_view_type"))
	 * ; if((dashidao_view_type != null) && (!dashidao_view_type.equals("")) &&
	 * (dashidao_view_type.equals("wap"))){ //String store_id =
	 * CommUtil.null2String(request.getSession(false).getAttribute("store_id")); mv
	 * = new JModelAndView("wap/404.html", this.configService.getSysConfig(),
	 * this.userConfigService.getUserConfig(), 1, request, response);
	 * mv.addObject("url", CommUtil.getURL(request) + "/wap/index.htm"); }
	 * 
	 * return mv; }
	 * 
	 * @RequestMapping({ "/500.htm" }) public ModelAndView
	 * error500(HttpServletRequest request, HttpServletResponse response){
	 * ModelAndView mv = new JModelAndView("500.html",
	 * this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1,
	 * request, response); String dashidao_view_type =
	 * CommUtil.null2String(request.getSession(false).getAttribute(
	 * "dashidao_view_type")); if((dashidao_view_type != null) &&
	 * (!dashidao_view_type.equals("")) && (dashidao_view_type.equals("wap"))){
	 * String store_id =
	 * CommUtil.null2String(request.getSession(false).getAttribute("store_id")); mv
	 * = new JModelAndView("wap/500.html", this.configService.getSysConfig(),
	 * this.userConfigService.getUserConfig(), 1, request, response);
	 * mv.addObject("url", CommUtil.getURL(request) + "/wap/index.htm?store_id=" +
	 * store_id); }
	 * 
	 * return mv; }
	 */
	 ...
	 * @return
	 */
	@RequestMapping({ "/wap/buyer/index.htm" })
	public ModelAndView wapbuyerindex(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("wap/buyer/index.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
		// 设置为wap访问
		request.getSession().setAttribute("dashidao_view_type", "wap");
		Map params = new HashMap();
		params.put("display", Boolean.valueOf(true));
		List gcs = this.goodsClassService.query(
				"select obj from GoodsClass obj where obj.parent.id is null and obj.display=:display order by obj.sequence asc",
		...
		mv.addObject("gcs", gcs);
		params.clear();
		params.put("ap_type", "wapslide");
		List gg = this.advertservice.query(
				"select obj from Advert obj where obj.ad_ap.ap_type=:ap_type order by obj.addTime asc", params, 0, 4);
		mv.addObject("gg", gg);
		params.clear();
	 ...
	 * @return
	 */
	@RequestMapping({ "/wap/yunke/index.htm" })
	public ModelAndView wapyunkeindex(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("wap/yunke/index.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
		// 设置为wap访问
		request.getSession().setAttribute("dashidao_view_type", "wap");
		Map params = new HashMap();
	...
	// 活动列表
	@RequestMapping({ "/wap/activity.htm" })
	@ResponseBody
	public void activity(HttpServletRequest request, HttpServletResponse response, String currentPage)
			throws IOException {
		Map params = new HashMap();
		ActivityQueryObject qo = new ActivityQueryObject(currentPage, params, "addTime", "desc");
		...
		set.add("ac_content");
		set.add("ac_rebate");
		includeMap.put(Activity.class, set);
	...
	// 活动商品列表
	@RequestMapping({ "/wap/activitygoods.htm" })
	@ResponseBody
	public void activitygoods(HttpServletRequest request, HttpServletResponse response, String currentPage, String acid)
			throws IOException {
		Map params = new HashMap();
		ActivityGoodsQueryObject qo = new ActivityGoodsQueryObject(currentPage, params, "addTime", "desc");
		qo.addQuery("obj.act.id", new SysMap("act_id", Long.parseLong(acid)), "=");
		qo.addQuery("obj.ag_status", new SysMap("ag_status", Integer.parseInt("1")), "=");
		...
		includeMap.put(ActivityGoods.class, set);
		set = new HashSet<String>();
		set.add("id");
	...
	// 团购列表
	@RequestMapping({ "/wap/groupgoods.htm" })
	@ResponseBody
	public void groupgoods(HttpServletRequest request, HttpServletResponse response, String currentPage)
			throws IOException {
		Map params = new HashMap();
		GroupGoodsQueryObject qo = new GroupGoodsQueryObject(currentPage, params, "addTime", "desc");
		...
		set.add("gg_price");
		set.add("gg_count");
		set.add("gg_group_count");
		set.add("gg_def_count");
		set.add("gg_vir_count");
		set.add("gg_min_count");
		set.add("gg_max_count");
		set.add("gg_rebate");
		set.add("gg_status");
		set.add("gg_recommend");
		set.add("gg_recommend_time");
		set.add("gg_content");
		set.add("gg_img");
		includeMap.put(Activity.class, set);
	...
	// 天天特价
	@RequestMapping({ "/wap/bargain_goods.htm" })
	@ResponseBody
	public void bargain_goods(HttpServletRequest request, HttpServletResponse response, String currentPage)
			throws IOException {
		Map params = new HashMap();
		BargainGoodsQueryObject qo = new BargainGoodsQueryObject(currentPage, params, "addTime", "desc");
		...
		set.add("bg_time");
		set.add("audit_time");
		includeMap.put(BargainGoods.class, set);
	...
	// 组合销售
	@RequestMapping({ "/wap/combin.htm" })
	@ResponseBody
	public void combin(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy,
			String orderType) throws IOException {
		Map params = new HashMap();
		GoodsQueryObject qo = new GoodsQueryObject(currentPage, params, orderBy, orderType);
	...
	// 买就送
	@RequestMapping({ "/wap/delivery.htm" })
	@ResponseBody
	public void delivery(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy,
			String orderType) throws IOException {
		Map params = new HashMap();
		DeliveryGoodsQueryObject qo = new DeliveryGoodsQueryObject(currentPage, params, orderBy, orderType);
