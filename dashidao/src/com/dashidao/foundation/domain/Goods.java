...
public class Goods extends IdEntity {
    ...
    @Lob
    @Column(columnDefinition = "LongText")
    private String buyer_know;
    //规格参数
    @Lob
    @Column(columnDefinition = "LongText")
    private String guige_canshu;
    ...
    private int goods_shzt;//2018、07、18 添加审核状态
    
    
    public int getGoods_shzt() {
		return goods_shzt;
	}

	public void setGoods_shzt(int goods_shzt) {
		this.goods_shzt = goods_shzt;
	}
    ...
    //照片
    @ManyToMany
    @JoinTable(name = "dashidao_goods_photo", joinColumns = {
    ...
    // 商品自定义分类
    @ManyToMany
    @JoinTable(name = "dashidao_goods_ugc", joinColumns = {
        @javax.persistence.JoinColumn(name = "goods_id")
    }, inverseJoinColumns = {
    ...
    // 商品规格，SKU
    @ManyToMany
    @JoinTable(name = "dashidao_goods_spec", joinColumns = {
        @javax.persistence.JoinColumn(name = "goods_id")
    }, inverseJoinColumns = {
    ...
    @ManyToMany
    @JoinTable(name = "dashidao_goods_combin")
    ...
    private String binding_area;
    
    @ManyToOne
    private User user;
    
    
    private int goods_zt;//云客推荐商品状态
    
    public int getGoods_zt() {
		return goods_zt;
	}

	public void setGoods_zt(int goods_zt) {
		this.goods_zt = goods_zt;
	}
	...
	public String getBuyer_know() {
		return buyer_know;
	}

	public void setBuyer_know(String buyer_know) {
		this.buyer_know = buyer_know;
	}

	public String getGuige_canshu() {
		return guige_canshu;
	}

	public void setGuige_canshu(String guige_canshu) {
		this.guige_canshu = guige_canshu;
	}

	public String getBinding_area() {
		return binding_area;
	}

	public void setBinding_area(String binding_area) {
		this.binding_area = binding_area;
	}
