...
import com.dashidao.foundation.domain.query.AlbumQueryObject;
import com.dashidao.foundation.service.*;
import com.dashidao.view.web.tools.AlbumViewTools;
 ...
 */
@Controller
public class AlbumPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册列表", value = "/poster/album.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album.htm"})
    public ModelAndView album(HttpServletRequest request, HttpServletResponse response, String currentPage){
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/poster/album.htm", "", "",
                                            pList, mv);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "新增相册", value = "/poster/album_add.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_add.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "新增相册", value = "/poster/album_edit.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册保存", value = "/poster/album_save.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片上传", value = "/poster/album_upload.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_upload.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册删除", value = "/poster/album_del.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_del.htm"})
        ...
        for (String id : ids){
            if (!id.equals("")){
                ...
                for (Accessory acc : accs){
                    ...
                    this.databaseTools
                    .execute("update dashidao_album set album_cover_id=null where album_cover_id=" +
                             acc.getId());
                }
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册封面设置", value = "/poster/album_cover.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_cover.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册转移", value = "/poster/album_transfer.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_transfer.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片转移相册", value = "/poster/album_transfer_save.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_transfer_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片列表", value = "/poster/album_image.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_image.htm"})
    public ModelAndView album_image(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/poster/album_image.htm",
                                            "", "&id=" + id, pList, mv);
        Map params = new HashMap();
        params.put("user_id", SecurityUserHolder.getCurrentUser().getId());
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片幻灯查看", value = "/poster/image_slide.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/image_slide.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "相册内图片删除", value = "/poster/album_img_del.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_img_del.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片转移相册", value = "/poster/album_watermark.htm*", rtype = "poster", rname = "图片管理", rcode = "album_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/album_watermark.htm"})
