...
import com.dashidao.foundation.domain.query.AccessoryQueryObject;
import com.dashidao.foundation.domain.query.GoodsQueryObject;
import com.dashidao.foundation.domain.query.ReportQueryObject;
import com.dashidao.foundation.domain.query.TransportQueryObject;
import com.dashidao.foundation.service.*;
import com.dashidao.lucene.LuceneUtil;
import com.dashidao.lucene.LuceneVo;
import com.dashidao.manage.admin.tools.StoreTools;
import com.dashidao.manage.seller.tools.TransportTools;
 ...
 */
@Controller
public class GoodsPosterAction {
    @Autowired
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "发布商品第一步", value = "/poster/add_goods_first.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/add_goods_first.htm" })
    public ModelAndView add_goods_first(HttpServletRequest request,
        ...
        if (store_status == 2){
            ...
            if ((grade.getGoodsCount() == 0)
                ...
                mv.addObject("op_title", "您的栈代等级只允许上传" + grade.getGoodsCount()
                             + "件商品!");
                mv.addObject("url", CommUtil.getURL(request)
                             + "/poster/store_grade.htm");
            }
        }
        if (store_status == 0){
            mv.addObject("op_title", "您尚未开通栈代，不能发布商品");
            mv.addObject("url", CommUtil.getURL(request) + "/poster/index.htm");
        }
        if (store_status == 1){
            mv.addObject("op_title", "您的栈代在审核中，不能发布商品");
            mv.addObject("url", CommUtil.getURL(request) + "/poster/index.htm");
        }
        if (store_status == 3){
            mv.addObject("op_title", "您的栈代已被关闭，不能发布商品");
            mv.addObject("url", CommUtil.getURL(request) + "/poster/index.htm");
        }
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品运费模板分页显示", value = "/poster/goods_transport.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_transport.htm" })
    public ModelAndView goods_transport(HttpServletRequest request,
        ...
        CommUtil.saveIPageList2ModelAndView(
            url + "/poster/goods_transport.htm", "", params, pList, mv);
        mv.addObject("transportTools", this.transportTools);

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "发布商品第二步", value = "/poster/add_goods_second.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/add_goods_second.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "产品规格显示", value = "/poster/goods_inventory.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_inventory.htm" })
    ...
    @RequestMapping({ "/poster/swf_upload.htm" })
    ...
    @RequestMapping({"/poster/upload.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品图片删除", value = "/poster/goods_image_del.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_image_del.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "发布商品第三步", value = "/poster/add_goods_finish.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/add_goods_finish.htm" })
    public ModelAndView add_goods_finish(HttpServletRequest request,
        ...
        if (goods_session1.equals("")){
            ...
            if (id.equals("")){
                ...
                String goods_lucene_path = (new StringBuilder(String.valueOf(System.getProperty("dashidao.root")))).append(File.separator).append("lucene").append(File.separator).append("goods").toString();
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "加载商品分类", value = "/poster/load_goods_class.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/load_goods_class.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "添加用户常用商品分类", value = "/poster/load_goods_class.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/add_goods_class_staple.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "删除用户常用商品分类", value = "/poster/del_goods_class_staple.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/del_goods_class_staple.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "根据用户常用商品分类加载分类信息", value = "/poster/del_goods_class_staple.htm*", rtype = "poster", rname = "商品发布", rcode = "goods_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/load_goods_class_staple.htm" })
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "出售中的商品列表", value = "/poster/goods.htm*", rtype = "poster", rname = "出售中的商品", rcode = "goods_list_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods.htm" })
    public ModelAndView goods(HttpServletRequest request,
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/poster/goods.htm", "",
                                            params, pList, mv);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "仓库中的商品列表", value = "/poster/goods_storage.htm*", rtype = "poster", rname = "仓库中的商品", rcode = "goods_storage_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_storage.htm" })
    public ModelAndView goods_storage(HttpServletRequest request,
        ...
        qo.addQuery("obj.goods_store.id", new SysMap("goods_store_id", user
                    .getStore().getId()), "=");
        qo.setOrderBy("goods_poster_time");
        qo.setOrderType("desc");
        if (org.apache.commons.lang.StringUtils.isNotEmpty(goods_name)){
            qo.addQuery("obj.goods_name", new SysMap("goods_name", "%"
                        + goods_name + "%"), "like");
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/poster/goods_storage.htm",
                                            "", params, pList, mv);
        mv.addObject("storeTools", this.storeTools);
        mv.addObject("goodsViewTools", this.goodsViewTools);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "违规下架商品", value = "/poster/goods_out.htm*", rtype = "poster", rname = "违规下架商品", rcode = "goods_out_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_out.htm" })
    public ModelAndView goods_out(HttpServletRequest request,
        ...
        IPageList pList = this.goodsService.list(qo);
        CommUtil.saveIPageList2ModelAndView(url + "/poster/goods_out.htm", "",
                                            params, pList, mv);
        mv.addObject("storeTools", this.storeTools);
        mv.addObject("goodsViewTools", this.goodsViewTools);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品编辑", value = "/poster/goods_edit.htm*", rtype = "poster", rname = "商品编辑", rcode = "goods_edit_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_edit.htm" })
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "商品上下架", value = "/poster/goods_sale.htm*", rtype = "poster", rname = "商品上下架", rcode = "goods_sale_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_sale.htm" })
    public String goods_sale(HttpServletRequest request,
                             HttpServletResponse response, String mulitId){
        String url = "/poster/goods.htm";
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品删除", value = "/poster/goods_del.htm*", rtype = "poster", rname = "商品删除", rcode = "goods_del_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_del.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "被举报禁售商品", value = "/poster/goods_report.htm*", rtype = "poster", rname = "被举报禁售商品", rcode = "goods_report_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/goods_report.htm" })
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "举报图片查看", value = "/poster/report_img.htm*", rtype = "poster", rname = "被举报禁售商品", rcode = "goods_report_poster", rgroup = "商品管理")
    @RequestMapping({ "/poster/report_img.htm" })
    ...
    @RequestMapping({ "/poster/goods_img_album.htm" })
