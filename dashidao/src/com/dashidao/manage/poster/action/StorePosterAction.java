...
import com.dashidao.core.tools.QRCodeEncoderHandler;
 ...
 */
@Controller
public class StorePosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请栈代第一步", value = "/poster/store_create_first.htm*", rtype = "buyer", rname = "申请栈代", rcode = "create_store", rgroup = "申请栈代")
    @RequestMapping({"/poster/store_create_first.htm"})
        ...
        if (this.configService.getSysConfig().isStore_allow()){
            ...
            if (store_status == 1){
                mv = new JModelAndView("error.html",
                                       ...
                                       response);
                mv.addObject("op_title", "您的栈代正在审核中");
            ...
            if (store_status == 3){
                mv = new JModelAndView("error.html",
                                       ...
                                       this.userConfigService.getUserConfig(), 1, request,
                                       response);
                mv.addObject("op_title", "您的栈代已经被关闭");
                mv.addObject("url", CommUtil.getURL(request) + "/index.htm");
            }
        }else{
            mv = new JModelAndView("error.html", this.configService.getSysConfig(),
                                   this.userConfigService.getUserConfig(), 1, request,
                                   response);
            mv.addObject("op_title", "系统暂时关闭了申请栈代");
            mv.addObject("url", CommUtil.getURL(request) + "/index.htm");
        }
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请栈代第二步", value = "/poster/store_create_second.htm*", rtype = "buyer", rname = "申请栈代", rcode = "create_store", rgroup = "申请栈代")
    @RequestMapping({"/poster/store_create_second.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请栈代完成", value = "/poster/store_create_finish.htm*", rtype = "buyer", rname = "申请栈代", rcode = "create_store", rgroup = "申请栈代")
    @RequestMapping({"/poster/store_create_finish.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代设置", value = "/poster/store_set.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_set.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代设置保存", value = "/poster/store_set_save.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_set_save.htm"})
    public ModelAndView store_set_save(HttpServletRequest request, HttpServletResponse response, String area_id, String store_second_domain){
        ...
        mv.addObject("op_title", "栈代设置成功");
        mv.addObject("url", CommUtil.getURL(request) + "/poster/store_set.htm");

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "栈代地图", value = "/poster/store_map.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_map.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代地图保存", value = "/poster/store_map_save.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_map_save.htm"})
    public ModelAndView store_map_save(HttpServletRequest request, HttpServletResponse response, String store_lat, String store_lng){
        ...
        this.storeService.update(store);
        mv.addObject("op_title", "栈代设置成功");
        mv.addObject("url", CommUtil.getURL(request) + "/poster/store_map.htm");

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "主题设置", value = "/poster/store_theme.htm*", rtype = "poster", rname = "主题设置", rcode = "store_theme_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_theme.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "主题设置", value = "/poster/store_theme_save.htm*", rtype = "poster", rname = "主题设置", rcode = "store_theme_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_theme_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代认证", value = "/poster/store_approve.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_approve.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代认证保存", value = "/poster/store_approve_save.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_approve_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代升级", value = "/poster/store_grade.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_grade.htm"})
    public ModelAndView store_grade(HttpServletRequest request, HttpServletResponse response){
        ...
        if (store.getUpdate_grade() == null){
            ...
            mv = new JModelAndView("user/default/usercenter/error.html",
                                   ...
                                   response);
            mv.addObject("op_title", "您的栈代升级正在审核中");
            mv.addObject("url", CommUtil.getURL(request) +
                         "/poster/store_set.htm");
        }

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "栈代升级申请完成", value = "/poster/store_grade_finish.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_grade_finish.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代幻灯", value = "/poster/store_slide.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_slide.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代幻灯保存", value = "/poster/store_slide_save.htm*", rtype = "poster", rname = "栈代设置", rcode = "store_set_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/store_slide_save.htm"})
