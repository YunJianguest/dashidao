 ...
 */
@Controller
public class GoodsBrandPosterAction extends IdEntity {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代品牌列表", value = "/poster/usergoodsbrand_list.htm*", rtype = "poster", rname = "品牌申请", rcode = "usergoodsbrand_poster", rgroup = "商品管理")
    @RequestMapping({"/poster/usergoodsbrand_list.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代品牌申请", value = "/poster/usergoodsbrand_add.htm*", rtype = "poster", rname = "品牌申请", rcode = "usergoodsbrand_poster", rgroup = "商品管理")
    @RequestMapping({"/poster/usergoodsbrand_add.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代品牌编辑", value = "/poster/usergoodsbrand_edit.htm*", rtype = "poster", rname = "品牌申请", rcode = "usergoodsbrand_poster", rgroup = "商品管理")
    @RequestMapping({"/poster/usergoodsbrand_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代品牌删除", value = "/poster/usergoodsbrand_dele.htm*", rtype = "poster", rname = "品牌申请", rcode = "usergoodsbrand_poster", rgroup = "商品管理")
    @RequestMapping({"/poster/usergoodsbrand_dele.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代品牌保存", value = "/poster/usergoodsbrand_save.htm*", rtype = "poster", rname = "品牌申请", rcode = "usergoodsbrand_poster", rgroup = "商品管理")
    @RequestMapping({"/poster/usergoodsbrand_save.htm"})
