 ...
 */
@Controller
public class GroupPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代团购列表", value = "/poster/group.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代团购添加", value = "/poster/group_add.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group_add.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代团购编辑", value = "/poster/group_edit.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代团购商品", value = "/poster/group_goods.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group_goods.htm"})
    ...
    @RequestMapping({"/poster/group_goods_load.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "团购商品保存", value = "/poster/group_goods_save.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group_goods_save.htm"})
    public String group_goods_save(HttpServletRequest request, HttpServletResponse response, String id, String group_id, String goods_id, String gc_id, String ga_id){
        ...
        request.getSession(false).setAttribute("url",
                                               CommUtil.getURL(request) + "/poster/group.htm");
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "团购商品删除", value = "/poster/group_del.htm*", rtype = "poster", rname = "团购管理", rcode = "group_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/group_del.htm"})
