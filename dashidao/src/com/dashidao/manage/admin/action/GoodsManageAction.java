...
public class GoodsManageAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品列表", value = "/admin/goods_yk_list.htm*", rtype = "admin", rname = "商品管理", rcode = "admin_goods", rgroup = "商品")
    @RequestMapping({"/admin/goods_yk_list.htm"})
    public ModelAndView goods_yk_list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType){
        System.out.println("商品列表");
    	ModelAndView mv = new JModelAndView("admin/blue/goods_yk_list.html",
                                            this.configService.getSysConfig(), this.userConfigService
                                            .getUserConfig(), 0, request, response);
        String url = this.configService.getSysConfig().getAddress();
        if ((url == null) || (url.equals(""))){
     ...
     * @throws IOException
     */
    @RequestMapping({"/admin/updateGoodszt.htm"})
    @ResponseBody
    public void updateGoodszt(HttpServletRequest request, HttpServletResponse response,String goodsId) throws IOException 
    {
    	...
    	if(goodsId!=null && !"".equals(goodsId)) 
    	{
    		...
    		goodsEntity.setGoods_zt(1);
    		boolean b = this.goodsService.update(goodsEntity);
    		if(b) {
    			params.put("state", "1");
    		}
    	}
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "商品上架审核", value = "/admin/goods_listcheck.htm*", rtype = "admin", rname = "商品管理", rcode = "admin_goods", rgroup = "商品")
    @RequestMapping({"/admin/goods_listcheck.htm"})
    public ModelAndView goods_listcheck(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType){
    	ModelAndView mv = new JModelAndView("admin/blue/goods_listcheck.html",
                                            this.configService.getSysConfig(), this.userConfigService
                                            .getUserConfig(), 0, request, response);
        String url = this.configService.getSysConfig().getAddress();
        if ((url == null) || (url.equals(""))){
        ...
        IPageList pList = this.goodsService.list(qo);
        CommUtil.saveIPageList2ModelAndView(url + "/admin/goods_listcheck.htm", "",
                                            params, pList, mv);
        return mv;
    }
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "商品上下架", value = "/admin/goods_check.htm*", rtype = "admin", rname = "商品上下架", rcode = "admin_goods", rgroup = "审核")
    @RequestMapping({ "/admin/goods_check.htm" })
    public String goods_check(HttpServletRequest request, HttpServletResponse response,String goodsid,String goods_shzt) {
    	 String url = "/admin/goods_listcheck.htm";
    	 if (!goodsid.equals("")){
    		 Goods goods = this.goodsService.getObjById(Long.valueOf(Long
                     .parseLong(goodsid)));
    		 
    		 goods.setGoods_shzt(Integer.parseInt(goods_shzt));
    		 this.goodsService.update(goods);
    	 }
    	 return "redirect:" + url;
    }
