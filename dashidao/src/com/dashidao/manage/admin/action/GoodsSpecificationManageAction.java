...
import com.dashidao.foundation.domain.query.GoodsSpecificationQueryObject;
...
public class GoodsSpecificationManageAction {
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType,String goodclassid){
        ModelAndView mv = new JModelAndView("admin/blue/goods_spec_list.html",
                                            this.configService.getSysConfig(), this.userConfigService
                                            .getUserConfig(), 0, request, response);
        
        Map map = new HashMap();
        map.put("goodclassid",goodclassid);
    ...
    public ModelAndView add(HttpServletRequest request, HttpServletResponse response,String goodclassid,String currentPage){
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id, String currentPage,String goodclassid){
        ModelAndView mv = new JModelAndView("admin/blue/goods_spec_add.html",
                                            this.configService.getSysConfig(), this.userConfigService
                                            .getUserConfig(), 0, request, response);
    ...
    public ModelAndView save(HttpServletRequest request, HttpServletResponse response, String id, String cmd, String count, String add_url, String list_url, String currentPage,String goodclassid){
        WebForm wf = new WebForm();
        ...
        goodsSpecification.setGoodclassid(goodclassid);
        if (id.equals(""))
        ...
        ModelAndView mv = new JModelAndView("admin/blue/success.html",
                                            this.configService.getSysConfig(), this.userConfigService
                                            .getUserConfig(), 0, request, response);
        mv.addObject("list_url", list_url + "?currentPage=" + currentPage+"&goodclassid="+goodclassid);
    ...
    public void goods_property_delete(HttpServletRequest request, HttpServletResponse response, String id){
        boolean ret = true;
        if (!id.equals("")){
            this.databaseTools.execute("delete from dashidao_goods_spec where spec_id=" +
                                       id);
            this.databaseTools.execute("delete from dashidao_cart_gsp where gsp_id=" +
                                       id);
