...
public class GoodsClassManageAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "基础设置", value = "/admin/jcsz_admin.htm*", rtype = "admin", rname = "基础设置", rcode = "jcsz_admin", rgroup = "系统设置")
    @RequestMapping({"/admin/jcsz_admin.htm"})
    public ModelAndView jcsz_admin(HttpServletRequest request, HttpServletResponse response, String pid){
        System.out.println("''''''''''''''''''''");
        ModelAndView mv = new JModelAndView("admin/blue/dodot/jcsz_admin.html",
