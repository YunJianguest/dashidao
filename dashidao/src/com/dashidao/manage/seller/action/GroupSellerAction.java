...
import com.dashidao.foundation.domain.Group;
import com.dashidao.foundation.domain.GroupArea;
import com.dashidao.foundation.domain.GroupClass;
import com.dashidao.foundation.domain.GroupGoods;
...
import com.dashidao.foundation.service.IGroupAreaService;
import com.dashidao.foundation.service.IGroupClassService;
...
public class GroupSellerAction {
    ...
    public void group_goods_load(HttpServletRequest request, HttpServletResponse response, String goods_name, String gc_id) throws UnsupportedEncodingException{
        goods_name = CommUtil.decode(goods_name);
        boolean ret = true;
        Map params = new HashMap();
