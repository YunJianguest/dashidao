...
public class BaseSellerAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "卖家中心导航", value = "/seller/shangPinTongZhi.htm*", rtype = "buyer", rname = "卖家中心导航", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/seller/shangPinTongZhi.htm"})
    public ModelAndView shangPinTongZhi(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView("user/default/usercenter/shangPinTongZhi.html", this.configService.getSysConfig(),
                                            this.userConfigService.getUserConfig(), 0, request, response);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "卖家中心导航", value = "/seller/adv.htm*", rtype = "buyer", rname = "卖家中心导航", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/seller/adv.htm"})
    public ModelAndView adv(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView(
            "user/default/usercenter/adv.html", this.configService
            .getSysConfig(),
            this.userConfigService.getUserConfig(), 0, request, response);
