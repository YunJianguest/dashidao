...
public class GoodsSellerAction {
    ...
    public ModelAndView add_goods_first(HttpServletRequest request,
        ...
        System.out.println(this.configService.getSysConfig().getConfig_payment_type());
...
//            return mv;
    ...
    public ModelAndView add_goods_finish(HttpServletRequest request,
                                         ...
                                         String goods_session, String transport_type, String transport_id,String buyer_know,String guige_canshu,String binding_area){
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "出售中的商品列表", value = "/*", rtype = "seller", rname = "出售中的商品", rcode = "goods_list_seller", rgroup = "商品管理")
    ...
    public ModelAndView goods(HttpServletRequest request,
        ...
        qo.addQuery("obj.goods_shzt",
                new SysMap("goods_shzt", Integer.valueOf(1)), "!=");
       ...
       /* List<Goods> l=pList.getResult();
        for(int i=0;i<l.size();i++){
            System.out.println(l.get(i).getGoods_specs());
        }*/
