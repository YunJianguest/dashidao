 ...
 */
@Controller
public class TransportPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板列表", value = "/poster/transport_list.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_list.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板添加", value = "/poster/transport_add.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_add.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板编辑", value = "/poster/transport_edit.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板复制", value = "/poster/transport_copy.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_copy.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板保存", value = "/poster/transport_save.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板保存成功", value = "/poster/transport_success.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_success.htm"})
    public ModelAndView transport_success(HttpServletRequest request, HttpServletResponse response, String currentPage){
        ...
        mv.addObject("url", CommUtil.getURL(request) +
                     "/poster/transport_list.htm?currentPage=" + currentPage);

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板删除", value = "/poster/transport_del.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_del.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板详细信息", value = "/poster/transport_info.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_info.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "栈代运费模板区域编辑", value = "/poster/transport_area.htm*", rtype = "poster", rname = "物流工具", rcode = "transport_poster", rgroup = "交易管理")
    @RequestMapping({"/poster/transport_area.htm"})
