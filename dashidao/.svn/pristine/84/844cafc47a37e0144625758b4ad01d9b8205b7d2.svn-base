...
import com.dashidao.foundation.domain.query.DeliveryLogQueryObject;
 ...
 */
@Controller
public class DeliveryPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送", value = "/poster/delivery.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送套餐购买日志", value = "/poster/delivery_log.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_log.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送套餐购买", value = "/poster/delivery_buy.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_buy.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送套餐购买保存", value = "/poster/delivery_buy_save.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_buy_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送套餐购买成功", value = "/poster/delivery_buy_success.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_buy_success.htm"})
    public ModelAndView delivery_buy_success(HttpServletRequest request, HttpServletResponse response){
        ...
        mv.addObject("url", CommUtil.getURL(request) + "/poster/delivery.htm");

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "买就送套餐购买失败", value = "/poster/delivery_buy_error.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_buy_error.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请买就送", value = "/poster/delivery_apply.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_apply.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "加载买就送商品", value = "/poster/delivery_goods.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_goods.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送商品保存", value = "/poster/delivery_apply_save.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_apply_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买就送删除", value = "/poster/delivery_del.htm*", rtype = "poster", rname = "买就送", rcode = "delivery_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/delivery_del.htm"})
