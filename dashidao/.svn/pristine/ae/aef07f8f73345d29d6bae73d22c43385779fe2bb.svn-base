package com.dashidao.manage.timer;
...
public class StatManageAction {
    ...
    private boolean send_email(OrderForm order, String mark) throws Exception {
        com.dashidao.foundation.domain.Template template = this.templateService
                .getObjByProperty("mark", mark);
        if (template.isOpen()){
            String email = order.getStore().getUser().getEmail();
            String subject = template.getTitle();
            String path = System.getProperty("dashidao.root") + "vm" + File.separator;
            ...
            p.setProperty("file.resource.loader.path", System.getProperty("dashidao.root") + "vm" + File.separator);
