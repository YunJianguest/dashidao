...
import com.dashidao.foundation.domain.Bargain;
import com.dashidao.foundation.domain.BargainGoods;
...
import com.dashidao.manage.poster.tools.BargainPosterTools;
 ...
 */
@Controller
public class BargainPosterAction {
    @Autowired
    ...
    @Autowired
    private BargainPosterTools bargainPosterTools;

    @SecurityMapping(display = false, rsequence = 0, title = "今日特价", value = "/poster/bargain.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain.htm"})
    public ModelAndView bargain(HttpServletRequest request, HttpServletResponse response){
        ...
        mv.addObject("bargainPosterTools", this.bargainPosterTools);

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "申请今日特价", value = "/poster/bargain_apply.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_apply.htm"})
    public ModelAndView bargain_apply(HttpServletRequest request, HttpServletResponse response, String bargain_time){
        ...
        List bargain = this.bargainService.query(
                           ...
                           params, 0, 1);
        int audit_count = this.bargainPosterTools
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "添加商品", value = "/poster/bargain_goods.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_goods.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品保存", value = "/poster/bargain_apply_save.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_apply_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "商品保存成功", value = "/poster/bargain_apply_success.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_apply_success.htm"})
    public ModelAndView bargain_apply_success(HttpServletRequest request, HttpServletResponse response, String bargain_time){
        ...
        .addObject("url", CommUtil.getURL(request) +
                   "/poster/bargain_goods_list.htm?bargain_time=" +
                   bargain_time);

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "商品保存失败", value = "/poster/bargain_apply_error.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_apply_error.htm"})
    public ModelAndView bargain_apply_error(HttpServletRequest request, HttpServletResponse response){
        ...
        mv.addObject("url", CommUtil.getURL(request) + "/poster/bargain.htm");

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "特价商品列表", value = "/poster/bargain_goods_list.htm*", rtype = "poster", rname = "今日特价", rcode = "bargain_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/bargain_goods_list.htm"})
