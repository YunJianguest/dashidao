 ...
 */
@Controller
public class SubAccountPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户列表", value = "/poster/sub_account_list.htm*", rtype = "poster", rname = "子账户管理", rcode = "sub_account_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/sub_account_list.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户添加", value = "/poster/sub_account_add.htm*", rtype = "poster", rname = "子账户管理", rcode = "sub_account_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/sub_account_add.htm"})
    public ModelAndView sub_account_add(HttpServletRequest request, HttpServletResponse response){
        ...
        if (user.getChilds().size() >= store.getGrade().getAcount_num()){
            mv = new JModelAndView("error.html", this.configService.getSysConfig(),
                                   this.userConfigService.getUserConfig(), 1, request,
                                   response);
            mv.addObject("op_title", "您的栈代等级不能继续添加子账户,请升级栈代等级");
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户编辑", value = "/poster/sub_account_edit.htm*", rtype = "poster", rname = "子账户管理", rcode = "sub_account_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/sub_account_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户保存", value = "/poster/sub_account_save.htm*", rtype = "poster", rname = "子账户管理", rcode = "sub_account_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/sub_account_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户删除", value = "/poster/sub_account_del.htm*", rtype = "poster", rname = "子账户管理", rcode = "sub_account_poster", rgroup = "栈代设置")
    @RequestMapping({"/poster/sub_account_del.htm"})
