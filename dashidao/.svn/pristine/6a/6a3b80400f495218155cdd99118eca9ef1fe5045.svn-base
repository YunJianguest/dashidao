...
public class GoldPosterAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "金币兑换", value = "/poster/gold_record.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_record.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "金币兑换保存", value = "/buyer/gold_record_save.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_record_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "金币兑换", value = "/poster/gold_record_list.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_record_list.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "金币兑换支付", value = "/poster/gold_pay.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_pay.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "金币兑换详情", value = "/poster/gold_view.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_view.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "兑换日志", value = "/poster/gold_log.htm*", rtype = "poster", rname = "金币管理", rcode = "gold_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/gold_log.htm"})
