...
public class TransAreaManageAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "物流模板列表", value = "/admin/twuliumuban_list.htm*", rtype = "admin", rname = "运费区域", rcode = "admin_twuliumuban", rgroup = "设置")
    @RequestMapping({"/admin/twuliumuban_list.htm"})
