...
public class SubAccountSellerAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户列表", value = "/seller/sub_account_listsj.htm*", rtype = "seller", rname = "子账户管理", rcode = "sub_account_listsj_seller", rgroup = "店铺设置")
    @RequestMapping({"/seller/sub_account_listsj.htm"})
    public ModelAndView sub_account_listsj(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType){
        ModelAndView mv = new JModelAndView(
            "user/default/usercenter/sub_account_listsj.html",
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "子账户添加", value = "/seller/sub_account_addsj.htm*", rtype = "seller", rname = "子账户管理", rcode = "sub_account_addsj_seller", rgroup = "店铺设置")
    @RequestMapping({"/seller/sub_account_addsj.htm"})
    public ModelAndView sub_account_addsj(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView(
            "user/default/usercenter/sub_account_addsj.html",
            this.configService.getSysConfig(),
            this.userConfigService.getUserConfig(), 0, request, response);
    ...
    public String sub_account_del(HttpServletRequest request, HttpServletResponse response, String mulitId){
        ...
        return "redirect:sub_account_listsj.htm";
    }
}
