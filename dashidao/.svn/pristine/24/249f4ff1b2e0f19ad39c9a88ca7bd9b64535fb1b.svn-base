package com.dashidao.core.constant;


public class Globals {
    public static final String DEFAULT_SYSTEM_TITLE = "大市道商城V3.0";
    ...
    public static final String DEFAULT_WBESITE_NAME = "大市道商城";
    ...
    public static final String DEFAULT_TABLE_SUFFIX = "dashidao_";
    public static final String THIRD_ACCOUNT_LOGIN = "dashidao_thid_login_";
