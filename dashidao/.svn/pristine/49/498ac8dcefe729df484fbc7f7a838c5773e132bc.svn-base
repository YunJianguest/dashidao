...
public class AreaManageAction {
    ...
    public ModelAndView area_import(HttpServletRequest request, HttpServletResponse response, String list_url) throws Exception {
        ...
        this.databaseTools.execute("update dashidao_store set area_id=null");

        this.databaseTools.execute("update dashidao_address set area_id=null");

        this.databaseTools.execute("update dashidao_area set parent_id=null");

        this.databaseTools.execute("delete from dashidao_area");
    ...
    public ModelAndView area_export(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String tables = "dashidao_accessory,dashidao_adv_pos,dashidao_advert,dashidao_articleclass,dashidao_article,dashidao_document,dashidao_navigation,dashidao_template,dashidao_sysconfig";
