...
import com.dashidao.foundation.domain.query.DynamicQueryObject;
import com.dashidao.foundation.domain.query.SnsAttentionQueryObject;
import com.dashidao.foundation.domain.query.SnsFriendQueryObject;
