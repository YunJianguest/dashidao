 ...
 */
@Controller
public class ActivityPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "活动列表", value = "/poster/activity.htm*", rtype = "poster", rname = "活动管理", rcode = "activity_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/activity.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请参加活动", value = "/poster/activity_apply.htm*", rtype = "poster", rname = "活动管理", rcode = "activity_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/activity_apply.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "活动商品加载", value = "/poster/activity_goods.htm*", rtype = "poster", rname = "活动管理", rcode = "activity_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/activity_goods.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请参加活动", value = "/poster/activity_apply_save.htm*", rtype = "poster", rname = "活动管理", rcode = "activity_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/activity_apply_save.htm"})
        ...
        if ((goods_ids != null) && (!goods_ids.equals(""))){
            ...
            if ((!activity_session1.equals("")) &&
                ...
                mv.addObject("url", CommUtil.getURL(request) +
                             "/poster/activity_goods_list.htm");
            }else{
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "活动商品列表", value = "/poster/activity_goods_list.htm*", rtype = "poster", rname = "活动管理", rcode = "activity_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/activity_goods_list.htm"})
