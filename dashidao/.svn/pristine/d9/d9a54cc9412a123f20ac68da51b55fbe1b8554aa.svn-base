...
import com.dashidao.foundation.domain.SpareGoods;
import com.dashidao.foundation.domain.SpareGoodsClass;
import com.dashidao.foundation.domain.query.SpareGoodsQueryObject;
 ...
 */
@Controller
public class SpareGoodsPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品列表", value = "/poster/spare_goods.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/spare_goods.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "发布闲置商品", value = "/poster/add_spare_goods.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/add_spare_goods.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品信息编辑", value = "/poster/spare_goods_edit.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/spare_goods_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品信息删除", value = "/poster/spare_goods_dele.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/spare_goods_dele.htm"})
    public ModelAndView spare_goods_dele(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ...
        if ((obj != null) && (!obj.equals(""))){
            ...
            mv.addObject("url", CommUtil.getURL(request) +
                         "/poster/spare_goods.htm?currentPage=" + currentPage);
        }else{
            mv = new JModelAndView("error.html", this.configService.getSysConfig(),
                                   this.userConfigService.getUserConfig(), 1, request,
                                   response);
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品下架上架操作", value = "/poster/spare_goods_updown.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/spare_goods_updown.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品保存", value = "/poster/spare_goods_save.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/spare_goods_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "闲置商品发布页Ajax加载下级地区信息", value = "/poster/sparegoods_area_data.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/sparegoods_area_data.htm"})
    ...
    @RequestMapping({"/poster/sparegoods_swf_upload.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "图片删除", value = "/poster/sparegoods_removeimg.htm*", rtype = "poster", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/poster/sparegoods_removeimg.htm"})
