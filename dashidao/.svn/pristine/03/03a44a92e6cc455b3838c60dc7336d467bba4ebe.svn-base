...
import com.dashidao.foundation.domain.PredepositCash;
import com.dashidao.foundation.domain.User;
import com.dashidao.foundation.domain.query.PredepositCashQueryObject;
import com.dashidao.foundation.service.IPredepositCashService;
