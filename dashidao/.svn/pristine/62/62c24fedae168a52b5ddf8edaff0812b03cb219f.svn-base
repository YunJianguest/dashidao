...
public class PoSunBuJiGl extends IdEntity {
	...
	public Date getZd_riqi() {
		return zd_riqi;
	}
	public void setZd_riqi(Date zd_riqi) {
	...
	public String getZd_yunke() {
		return zd_yunke;
	}
	public void setZd_yunke(String zd_yunke) {
		this.zd_yunke = zd_yunke;
	}
