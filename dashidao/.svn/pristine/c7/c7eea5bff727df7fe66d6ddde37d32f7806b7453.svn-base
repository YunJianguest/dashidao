...
import com.dashidao.foundation.domain.query.AdvertPositionQueryObject;
import com.dashidao.foundation.domain.query.AdvertQueryObject;
 ...
 */
@Controller
public class AdvertPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "广告列表", value = "/poster/advert_list.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_list.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "广告购买", value = "/poster/advert_apply.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_apply.htm"})
    ...
    @RequestMapping({"/poster/advert_vefity.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "广告购买保存", value = "/poster/advert_apply_save.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_apply_save.htm"})
    public ModelAndView advert_apply_save(HttpServletRequest request, HttpServletResponse response, String id, String ap_id, String ad_begin_time, String month, String ap_session){
        ...
        if (ap_session1.equals("")){
            ...
            mv.addObject("url", CommUtil.getURL(request) +
                         "/poster/advert_my.htm");
        }

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "广告编辑", value = "/poster/advert_apply_edit.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_apply_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "我的广告", value = "/poster/advert_my.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_my.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "广告延时", value = "/poster/advert_delay.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_delay.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "广告购买保存", value = "/poster/advert_delay_save.htm*", rtype = "poster", rname = "广告管理", rcode = "advert_poster", rgroup = "其他设置")
    @RequestMapping({"/poster/advert_delay_save.htm"})
