...
import com.dashidao.foundation.domain.query.CombinLogQueryObject;
 ...
 */
@Controller
public class CombinPosterAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售", value = "/poster/combin.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售购买日志", value = "/poster/combin_log.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_log.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "申请组合销售", value = "/poster/combin_apply.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_apply.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "销售组合编辑", value = "/poster/combin_edit.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_edit.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售保存", value = "/poster/combin_save.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_save.htm"})
    public ModelAndView combin_save(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String combin_session, String combin_begin_time, String combin_end_time, String combin_main_goods_id, String combin_goods_ids, String combin_price, String id){
        ...
        mv.addObject("url", CommUtil.getURL(request) +
                     "/poster/combin.htm?currentPage=" + currentPage);

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "组合销售删除", value = "/poster/combin_del.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_del.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售套餐购买", value = "/poster/combin_buy.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_buy.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售套餐购买保存", value = "/poster/combin_buy_save.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_buy_save.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "组合销售套餐购买成功", value = "/poster/combin_buy_success.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_buy_success.htm"})
    public ModelAndView combin_buy_success(HttpServletRequest request, HttpServletResponse response){
        ...
        mv.addObject("url", CommUtil.getURL(request) + "/poster/combin.htm");

        return mv;
    }

    @SecurityMapping(display = false, rsequence = 0, title = "组合销售套餐购买失败", value = "/poster/combin_buy_error.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_buy_error.htm"})
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "加载商品", value = "/poster/combin_goods.htm*", rtype = "poster", rname = "组合销售", rcode = "combin_poster", rgroup = "促销管理")
    @RequestMapping({"/poster/combin_goods.htm"})
    public ModelAndView combin_goods(HttpServletRequest request, HttpServletResponse response, String goods_name, String currentPage, String target_id, String goods_type){
        ...
        CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) +
                                            "/poster/combin_goods.htm", "", "&goods_name=" + goods_name,
                                            pList, mv);
